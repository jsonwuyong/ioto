...
public class ImageUtil {
    ...
    public static void main(String[] args) throws IOException {
        Thumbnails.of(new File("/Users/dengting/Documents/web-code/source/ioio.jpg")).size(500, 500)
                .watermark(Positions.BOTTOM_RIGHT, ImageIO.read(new File(basePath + "/watermark.jpg")), 0.25f)
                .outputQuality(0.8f).toFile("/Users/dengting/Documents/web-code/source/ioionew.jpg");
    }
